...
public class SupportSystem
{
    ...
    public void start()
    {
        ...
        while(!finished) {
            ...
            input = input.trim(); // TODO: Single line might be more effective: getInput().trim();
            
            // Exercise 5.9: make program ignore case-sensitivity.
            input = input.toLowerCase(); // TODO: Again, single line might be better.
            
            
            // 5.11: Change implementation to equals instead of startswith.
            // This ensures that we refer to the content of the string
